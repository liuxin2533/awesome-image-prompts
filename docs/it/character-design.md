...
### 1. Infografica / Contenuto Visual Educativo - Infografica sull'identità del brand in stile manga

<img src="https://cms-assets.youmind.com/media/1777971019409_hnyskv_HHfhKxxaYAA0tBI.jpg" alt="Infografica / Contenuto Visual Educativo - Infografica sull'identità del brand in stile manga" width="480">
...
- **Fonte:** [YouMind-OpenLab/awesome-gpt-image-2](https://x.com/you1873118/status/2051355742150762898)

**Prompt:**

```text
Utilizzando il logo caricato, crea un'infografica dettagliata in stile poster manga:

Titolo: "Cosa trasmette questo brand"
Obiettivo: Trasformare il brand in un "individuo vivente" e dimostrare visivamente come agisce, parla e interagisce con il mondo.
Fusione: Strategia del brand + Character Design + Narrazione manga

Regola fondamentale: Tutti i contenuti devono derivare dal logo stesso (colori, stile, tono, personalità). Niente descrizioni di personalità generiche.

Struttura: {argument name="layout" default="Poster verticale 4:5"}, layout a più riquadri ricco di informazioni, {argument name="style" default="stile ibrido manga + infografica"}.

Personaggio principale: Crea un personaggio centrale che rappresenti la personificazione del brand. L'abbigliamento, la postura e l'espressione devono riflettere l'identità del brand.
Riquadri: 6–8 riquadri manga che mostrano comportamenti in scenari come l'interazione con il cliente, la gestione della concorrenza o la presenza sui social media.
Tratti: Sezioni modulari che mostrano lo stile del tono, il livello di energia e i metodi di comunicazione utilizzando icone.
Cosa fare/Cosa non fare: Guida visiva sui comportamenti coerenti e incoerenti con il brand.
Risultato finale: Deve apparire come una tavola strategica di brand personificato da collezione, non come qualcosa di piatto o generico.
```

<a id="prompt-37d4b0d6a17e8b31b31e"></a>

### 2. Fumetto / Storyboard - Foglio di studio per Squash and Stretch del salto

<img src="https://cms-assets.youmind.com/media/1777971046177_dbw6gh_HHeUIYyXYAA9plV.jpg" alt="Fumetto / Storyboard - Foglio di studio per Squash and Stretch del salto" width="480">
...
- **Fonte:** [YouMind-OpenLab/awesome-gpt-image-2](https://x.com/techhalla/status/2051273934356595196#reversed-1)

**Prompt:**

```text
Utilizzando REFERENCE_0 come base per il personaggio, crea un foglio di movimento animato pulito che trasformi il personaggio in uno studio sequenziale di un salto a figura intera, preservando lo stesso abbigliamento, distintivo, testa calva, scarpe, lo stile di illustrazione a inchiostro e colore, e il trattamento di censura/sfocatura del volto. Espandi la visualizzazione dal ritratto ritagliato a un layout ampio con texture di carta beige, includendo una linea del terreno, sottili linee di movimento, piccoli segni di impatto e tipografia didattica. Aggiungi il titolo {argument name="title text" default="SQUASH AND STRETCH"} in alto a sinistra con il sottotitolo {argument name="subtitle text" default="JUMP SEQUENCE — 7 STAGES"}. Mostra esattamente 7 pose numerate disposte da sinistra a destra lungo la pagina: 1 “ANTICIPATION (CROUCHING)” con il personaggio accovacciato e le braccia all'indietro; 2 “EXTREME SQUASH (COMPRESSED)” con un accovacciamento più profondo e compatto; 3 “EXTREME STRETCH (TAKEOFF)” con il personaggio allungato verso l'alto, braccia sollevate, piedi che lasciano il suolo; 4 “APEX (MID-AIR ARC)” con il personaggio rannicchiato a mezz'aria; 5 “STRETCH (DOWNWARD ACCELERATION)” con il personaggio allungato verticalmente durante la discesa; 6 “SQUASH (IMPACT LANDING)” con il personaggio compresso all'atterraggio, una mano che tocca terra; 7 “RECOVERY (RETURN TO STANCE)” con il personaggio in piedi, rilassato, con le mani in tasca. Utilizza etichette in grassetto nero in maiuscolo sotto ogni fase numerata, mantieni proporzioni coerenti del personaggio tra le pose, eccetto per la deformazione intenzionale di squash-and-stretch, e rendi il foglio simile a un grafico di riferimento professionale per l'animazione 2D.
```
...
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/sciencedegens/status/2049359171594903856)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/yume00112211/status/2048309139013853421)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/ismajc/status/2048166630933282995)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/ismajc/status/2048174302164394493)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/almimeister/status/2048309710118687101)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/Toshi_nyaruo_AI/status/2045025277538107420)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/09lyco/status/2045281845391323175)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/loglogrog/status/2046448773162033240)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/songguoxiansen/status/2046476566537080849)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/iamrednightS/status/2045075682837836265)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-166)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-121)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-160)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-27)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-208)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-340)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-304)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-325)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-246)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-290)
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-54)
...
### 24. Black Myth Pan Jinlian stunning game cover
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-207)
...
### 25. Cute Character Setting Sheet
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-372)
...
### 26. Red and Blue Color Block High Heels Temptation
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-326)
...
### 27. Little Prince and Starship Romantic Collaboration
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-250)
...
- **Categorie:** Character Design
- **Fonte:** [EvoLinkAI/awesome-gpt-image-2-prompts](https://x.com/songguoxiansen/status/2047198090009190441)
...
### 29. GTA 6 Style In-Game Footage

<img src="https://pbs.twimg.com/media/HFPAX19XMAAJ8V_?format=jpg&amp;name=large" alt="GTA 6 Style In-Game Footage" width="480">

- **Categorie:** Character Design
- **Fonte:** [ZeroLu/awesome-gpt-image](https://x.com/WolfRiccardo/status/2041187268711321735)
...
### 30. Official Character Profile Card
...
- **Categorie:** Character Design
- **Fonte:** [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2#case-306)
...
### 31. Fumetto / Storyboard - Cute Monster Ability Design Sheet

<img src="https://cms-assets.youmind.com/media/1777367353063_slhrxs_HG8SV3XagAEU7La.jpg" alt="Fumetto / Storyboard - Cute Monster Ability Design Sheet" width="480">
...
- **Categorie:** Comic & Story
- **Fonte:** [YouMind-OpenLab/awesome-gpt-image-2](https://x.com/Design4p0/status/2048876977717686631#reversed-0)
